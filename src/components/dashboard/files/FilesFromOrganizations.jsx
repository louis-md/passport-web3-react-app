...
class FilesFromOrganizations extends Component {
  constructor(props){
      super(props);
  }
      ...
      <div className="big-container manage-products-wrapper">
        <div className="modal-dialog">
          <div className="modal-content">
            <h3 className="manage-products-title">Files shared by your organizations<br/><br/></h3>
...
export default FilesFromOrganizations;